...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  const fullName = profile ? `${profile.firstName} ${profile.lastName}` : "Guest User";
      ...
      <div className="bg-white h-[70px] flex justify-between items-center px-6 dm-font leading-[100%]">
        <div className="">
          <h2 className="text-[16px] font-[600] text-[var(--black-white-1000)] hidden lg:flex">
            {isLoadingProfile ? "Loading..." : `${getGreeting()}, ${firstName}!`}
          </h2>
        ...
        <div className="flex items-center gap-[15px]">
          ...
          <div className="relative">
            ...
            {unreadCount > 0 && (
              <div className="absolute -top-1 -right-1 bg-[#FF5151] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
          ...
          <div className="relative flex items-center gap-[10px]">
            {/* Profile Image */}
            <Image
              src={profile?.avatarUrl || "/Mask Group.png"}
              alt="profile-pic"
              width={35}
              height={35}
